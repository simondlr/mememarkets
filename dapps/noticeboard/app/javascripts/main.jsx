...
import MemeStatsPage from "./memestatspage.jsx";
import NoticeboardPage from "./noticeboardpage.jsx";
import NoticeboardFrontPage from "./noticeboardfrontpage.jsx";
  ...
  //React.render((
    <Router history={history}>
      <Route path="/" component={App}>
        ...
        <Route path="/stats/meme/:memeStr" component={MemeStatsPage} />
        <Route path="/noticeboard" component={NoticeboardFrontPage} />
        <Route path="/noticeboard/meme/:memeStr" component={NoticeboardPage} />
      </Route>
    </Router>
